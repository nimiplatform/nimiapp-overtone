      ...
      Overtone: {
        ...
        common: {
          readiness: {
            ...
            music: 'Music',
            text: 'Text',
            realmNotConnectedHint: 'Realm is not connected in this build, so publishing stays unavailable.',
          },
          status: {
            ready: 'ready',
            checking: 'Checking…',
        ...
        empty: {
          ...
          steps: {
            ariaLabel: 'Creation flow',
            configure: 'Configure AI models',
            brief: 'Write a song brief',
        ...
        takes: {
          ...
          generateAnother: 'Generate another take',
          generating: 'Generating...',
      ...
      Overtone: {
        ...
        common: {
          readiness: {
            ...
            music: '音乐',
            text: '文本',
            realmNotConnectedHint: '当前版本未接入 Realm，发布功能暂不可用。',
          },
          status: {
            ready: '就绪',
            checking: '检查中…',
