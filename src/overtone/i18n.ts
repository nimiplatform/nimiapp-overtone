    ...
    translation: {
      Overtone: {
        ...
        workspace: {
          ...
          readiness: {
            degraded: 'Runtime is degraded; some connectors may be unavailable.',
            musicUnavailable: 'No music connector/model pair is ready.',
            textUnavailable: 'No text connector/model pair is ready.',
          },
        },
        empty: {
        ...
        brief: {
          ...
          manual: 'Manual Brief',
          noTextRoute: 'No text connector/model pair is ready. Use Manual Brief or configure runtime text access.',
          fields: {
            title: 'Title',
            genre: 'Genre',
            mood: 'Mood',
        ...
        generate: {
          ...
          warningNoMusicRoute: 'No music connector/model pair is ready. Configure runtime music access before generating.',
        ...
        iteration: {
          ...
          warningNoMusicRoute: 'No music connector/model pair is ready. Configure runtime music access before iterating.',
        ...
        publish: {
          ...
          proxyRequiredError: 'Realm publishing for developer-registered local apps requires a Runtime/Realm publish proxy. Overtone cannot publish through raw Realm access tokens.',
          proxyUnavailable: 'Realm publishing is unavailable for developer-registered local apps until a platform publish proxy is admitted.',
    ...
    translation: {
      Overtone: {
        ...
        workspace: {
          ...
          readiness: {
            degraded: 'Runtime 处于降级状态，部分连接器可能不可用。',
            musicUnavailable: '没有就绪的音乐连接器/模型组合。',
            textUnavailable: '没有就绪的文本连接器/模型组合。',
          },
        },
        empty: {
        ...
        brief: {
          ...
          generate: 'AI 生成简报',
          manual: '手动简报',
          noTextRoute: '没有就绪的文本连接器/模型组合。请使用手动简报，或配置 Runtime 文本访问能力。',
          fields: {
            title: '标题',
            genre: '曲风',
            mood: '情绪',
        ...
        generate: {
          ...
          warningNoMusicRoute: '没有就绪的音乐连接器/模型组合。生成前请先配置 Runtime 音乐访问能力。',
          submit: '生成歌曲',
          submitting: '生成中...',
          untitled: '未命名',
        ...
        iteration: {
          ...
          warningNoMusicRoute: '没有就绪的音乐连接器/模型组合。迭代前请先配置 Runtime 音乐访问能力。',
          submit: '创建子版本',
          submitting: '迭代中...',
          childTitle: '{{title}} - {{mode}}',
          errors: {
        ...
        publish: {
          ...
          publishedButton: '已发布',
          publishNow: '立即发布',
          proxyRequiredError: '开发者注册的本地应用需要 Runtime/Realm 发布代理才能发布到 Realm。Overtone 不能通过原始 Realm 访问令牌发布。',
          proxyUnavailable: '开发者注册的本地应用在平台发布代理准入前无法使用 Realm 发布。',
